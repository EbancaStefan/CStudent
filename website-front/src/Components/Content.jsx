...
export default function Content() {
  ...
  return (
    <div className="content">
      ...
      <div className="iframe_links">
        <div className="anunturi_content">
         ...
         <button className="IpadButton"
             onClick={() => onClickChangeIframeURL()}
             typeof="button"
          >
              <a className="square"/>
      ...
      <div className="activitate_curenta">Activitatea Curenta</div>
      <div className="activitate_urmatoare">Activitatea Urmatoare</div>
    </div>
  );
}
